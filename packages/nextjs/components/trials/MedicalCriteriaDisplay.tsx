 ...
 *
 * Shows eligibility criteria in human-readable format for patients
 */
      ...
      <div className="mt-4 p-3 rounded-lg bg-blue-50 border border-blue-200">
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-blue-700">
            ...
            <p>
              Your medical data never leaves your device. You&apos;ll generate a zero-knowledge proof
              to prove eligibility without revealing exact health information.
            </p>
          </div>
        </div>
      </div>
