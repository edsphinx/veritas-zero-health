...
import { RouteGuard, RouteGuardProps } from '@/presentation/components/auth/RouteGuard';
...
export function ResearcherLayout({ children }: { children: ReactNode }) {
  return (
    <PortalLayout
      requireAuth
      requireVerification
      allowedRoles={['researcher' as any]}
      background="default"
      showSidebar={true}
      sidebarCollapsed={false}
    >
