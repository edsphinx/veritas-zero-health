...
function toStudyDB(prismaStudy: PrismaStudy): StudyDB {
  return {
    ...
    wizardCompleted: prismaStudy.wizardCompleted,
    wizardStepsCompleted: prismaStudy.wizardStepsCompleted,
    wizardCompletedAt: prismaStudy.wizardCompletedAt,
    milestonesTxHash: prismaStudy.milestonesTxHash,
    milestonesBlockNumber: prismaStudy.milestonesBlockNumber,
    milestonesIndexedAt: prismaStudy.milestonesIndexedAt,
