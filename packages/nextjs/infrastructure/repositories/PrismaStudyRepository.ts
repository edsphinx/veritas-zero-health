...
export class PrismaStudyRepository implements IStudyRepository {
  ...
  private toDomain(prismaStudy: any): Study {
    return {
      ...
      status: prismaStudy.status as StudyStatus,
      ...
      escrowBlockNumber: BigInt(prismaStudy.escrowBlockNumber),
      registryBlockNumber: BigInt(prismaStudy.registryBlockNumber),
