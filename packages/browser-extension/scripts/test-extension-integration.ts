 ...
 */
async function testStoreRecord(type: string, data: any): Promise<string> {
  console.log(`\n📤 Testing Store: ${type}`);
 ...
 */
async function testGetRecords(type: string): Promise<HealthRecord[]> {
 ...
 */
async function testDeleteRecord(type: string, recordId: string): Promise<void> {
