 ...
 * @returns {any}
 */
export function generate_eligibility_proof(srs_key, proving_key, input) {
    try {
        ...
        wasm.generate_eligibility_proof(retptr, ptr0, len0, ptr1, len1, addHeapObject(input));
 ...
 * @returns {any}
 */
export function verify_eligibility_proof(srs_key, verifying_key, proof, public_inputs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(srs_key, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.verify_eligibility_proof(retptr, ptr0, len0, ptr1, len1, addHeapObject(proof), addHeapObject(public_inputs));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
