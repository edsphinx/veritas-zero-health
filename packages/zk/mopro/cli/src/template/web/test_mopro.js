    ...
    const testCases = [
        {
            ...
            pk: './assets/plonk_eligibility_pk.bin',
            vk: './assets/plonk_eligibility_vk.bin',
            generateProof: mopro_wasm.generate_eligibility_proof,
            verifyProof: mopro_wasm.verify_eligibility_proof,
        },
        {
            name: "Plonk",
            input: { out: ["55"] },
